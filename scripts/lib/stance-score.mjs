...
const CUES={
 ...
 it:{for:{verb:["sosten(?:uto|uta|uti|ute|ere|eva|evano|gono|go|iamo)(?!\\s+che)","sostiene(?!\\s+che)","appoggi(?:a|ano|ato|are|ava)","approv(?:a|ano|are|ato|ava)","accett(?:a|ano|are|ato|ava)","difend(?:e|ono|ere|eva)",`${DIRE_IT} a favore`,"si a(?:ll|lla|l|d)?","raccomand\\p{L}* (?:di accettare|l'accettazione|di approvare|di sostenere)"],
